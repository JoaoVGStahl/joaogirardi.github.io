              ...
              <div className="mx-auto w-full max-w-3xl space-y-8">
                <div className="relative pl-8 border-l-2 border-muted-foreground/20">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">PONTO.SYS SISTEMAS | Novembro 2021 - Atual</p>
                    <p className="text-gray-500 dark:text-gray-400">
                ...
                <div className="relative pl-8 border-l-2 border-muted-foreground/20">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-xl font-bold">Formação em Análise e Desenvolvimento de Sistemas</h3>
                    <p className="text-sm text-muted-foreground">UNOPAR-EAD | 2019 - 2022</p>
                    <p className="text-gray-500 dark:text-gray-400">
                      Ensino superior com foco em desenvolvimento de software e análise de sistemas.
                    </p>
                  </div>
                </div>
                <div className="relative pl-8">
                  <div className="absolute left-[-8px] top-0 h-4 w-4 rounded-full bg-muted-foreground"></div>
                  <div className="space-y-2">
                    <h3 className="text-xl font-bold">Curso Técnico em Desenvolvimento de Sistemas</h3>
                    <p className="text-sm text-muted-foreground">ETEC IDIO ZUCCHI | 2020 - 2021</p>
                    <p className="text-gray-500 dark:text-gray-400">
                      Programação Full Stack, Desktop, e Banco de dados relacional.
                    </p>
                  </div>
                </div>
              </div>
